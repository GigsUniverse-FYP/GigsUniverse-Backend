...
@Component
public class CustomOAuth2FreelancerHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        String userId = session != null ? (String) session.getAttribute("pendingFreelancerId") : null;
        ...
        if (session != null) {
            session.removeAttribute("pendingFreelancerId");
        ...
        if (error != null) {
            ...
            response.sendRedirect(frontendUrl + "/register/freelancer/google-success" +
                "?id=" + userId +
                "&email=" + userEmail);
        }
    }
